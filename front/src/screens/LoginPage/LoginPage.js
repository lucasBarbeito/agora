    ...
    if (verificationEmail) {
      try {
        ...
        if (response.status === 401) {
          ...
          this.setState({
            errorMsg: "No existe un usuario con la información ingresada",
            invalidInformation: true,
          });
        } else if (!response.ok) {
          this.setState({
          ...
          <Box className="login-page-form-box" boxShadow={2}>
            <div className="login-page-header">
              ...
              <p className="login-page-subtitle">
                <div>
                  Ingresa los datos de tu cuenta. Si no tienes una, puedes
                </div>
                <div>
                  crearla{" "}
                  <span
            ...
            <Button id="login-page-create-button" onClick={this.handleLogin}>
              Ingresar
            </Button>
          </Box>
        </div>
